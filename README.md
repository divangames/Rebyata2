...
PWA-посадочник химчистки, реставрации и ремонта «Свои ребята». Сверстан mobile-first по макетам: шесть экранов лендинга, нижняя навигация и оценка по фото. На экранах от 1024px — отдельная десктопная композиция: широкая сетка секций, шапка с якорями и кнопкой оценки.
