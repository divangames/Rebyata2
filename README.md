...
- `src/components` — блоки экранов, шапка, док с выпадашкой у «+», шторка оценки (несколько фото с миниатюрами) и заявка на курьера; в «Примерах работ» сравнение кадров в модалке; в подвале — рукописный акцент, стрелка и мессенджеры
