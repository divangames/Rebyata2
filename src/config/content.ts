...
export const courierCopy = {
  ...
  submitMessenger: "Написать и согласовать",
...
export const requestCopy = {
  ...
  sent: "Заявка принята. Перезвоним в течение 2–3 минут.",
...
export const evaluateCopy = {
  ...
  phoneError: "Укажите номер телефона",
  channelError: "Выберите способ связи",
} as const;
...
export const howSteps: HowStep[] = [
  ...
  },
  {
    ...
    text: "Ответ отправим в выбранный мессенджер до 15 мин",
  },
  {
